<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="gestion_fonctions.aspx.vb" Inherits="entite_fontions_gestion_fonctions" %>
    ...
    <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                ...
                <p class="blue-text">Catégorisation les differents fonctions/métiers en FMPS</p>
                <div class="card p-lg-5 p-3">
                    <h5 class="text-center m-3 mb-4">Ajouter nouveau fonction : </h5>
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex"> 
                                <label class="form-control-label px-3">Titre de fonction : <span class="text-danger"> *</span>
                                </label> 
                                <asp:TextBox ID="txt_titreFr" runat="server" cssClass="form-control" placeholder="Entre le nom de fonction (FR)" > </asp:TextBox>
                            </div>
                            <div class="form-group col-sm-6 flex-column d-flex"> 
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex"> 
                                ...
                                <asp:DropDownList CssClass="form-control" runat="server" ID="ent_dropDown">
                        ...
                        <div class="row justify-content-between align-items-center p-0 text-left">
                            ...
                            <div class="form-group col-sm-12 d-flex flex-column mb-4 m-0 col-lg-12"> 
                                <label></label>
    ...
    <div id="container" class="p-lg-5">
        <asp:Repeater ID="foncs_repeater" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                <asp:Label ID="Label_id" runat="server" Text='<%# Eval("id_emp_fonction")%>'></asp:Label>
                            </td>
                            <td>
                                <%# Eval("nom_fonction")%>
                            </td>
                            <td>
                                <%# Eval("nom_fonction_ar")%>
                            </td>
                            <td>
                                <%# Eval("titre")%>
                            </td>
                            ...
                            <td class="d-flex justify-content-center">
                                <asp:LinkButton OnClick="LinkButton_delete_Click" CausesValidation="false" runat="server" ID="LinkButton_delete" class="p-2 show_detail text-danger m-2"><i class="fas fa-times"></i></asp:LinkButton>
                                <a data-id='<%# Eval("id_emp_fonction")%>' class="p-2 afficher_data show_detail text-primary m-2"><i class="fas fa-marker"></i></a>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.afficher_data', function () {
                var id = $(this).data('id');
                console.log(id);
                $('#Iframe_Afficher').attr('src', "ModifierFonctionModal.aspx?id_fonc=" + id);
